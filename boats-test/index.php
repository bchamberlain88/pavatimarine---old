...
echo"<div class='main-container'>
   ...
   <div class="oar-block">
	   	...
	   	<img src="../imgs/oars/sawyer-dynelite-oar-with-blade.jpg" />

	   	<ul class="oar-specs">

	   		<h2>Sawyer Dynelite Oar with blade</h2>

	   		<label>Stiffness</label>
	   		<li id="stiffness"><p>5 / 10</p><span class="value" data-value="50" style="width:50%;"></span></li>
	   		<label>Durability</label>
	   		<li id="durability"><p>10 / 10</p><span class="value" data-value="100" style="width:100%;"></span></li>
	   		<label>Feathering</label>
	   		<li id="feathering"><p>10 / 10</p><span class="value" data-value="100" style="width:100%;"></span></li>
	   	</ul>
   </div>
   ...
   <div class="oar-block">
	   	...
	   	<img src="../imgs/oars/sawyer-dynelite-oar-with-shoal-cut-blade.jpg" />

	   	<ul class="oar-specs">

	   		<h2>Sawyer Dynelite Oar with Shoal-Cut Blade</h2>
	   		...
	   		<li id="durability"><p>10 / 10</p><span class="value" data-value="100" style="width:100%;"></span></li>
	   		<label>Feathering</label>
	   		<li id="feathering"><p>5 / 10</p><span class="value" data-value="50" style="width:50%;"></span></li>
	   	</ul>
   ...
   <div class="oar-block">
	   	...
	   	<img src="../imgs/oars/sawyer-polecat-oar-with-duramax-blade.jpg" />

	   	<ul class="oar-specs">

	   		<h2>Sawyer Polecat Oar with Duramax Blade</h2>

	   		<label>Stiffness</label>
	   		<li id="stiffness"><p>10 / 10</p><span class="value" data-value="100" style="width:100%;"></span></li>
	   		<label>Durability</label>
	   		<li id="durability"><p>5 / 10</p><span class="value" data-value="50" style="width:50%;"></span></li>
	   		<label>Feathering</label>
	   		<li id="feathering"><p>4 / 10</p><span class="value" data-value="40" style="width:40%;"></span></li>
	   	</ul>

   </div>


   <div class="oar-block starred">

	   	<img src="../imgs/oars/sawyer-square-top-oar-with-dynelite-blade.jpg" />

	   	<ul class="oar-specs">

	   		<h2>Sawyer Square-Top Oar with Dynelite Blade</h2>

	   		<label>Stiffness</label>
	   		<li id="stiffness"><p>3 / 10</p><span class="value" data-value="30" style="width:30%;"></span></li>
	   		<label>Durability</label>
	   		<li id="durability"><p>10 / 10</p><span class="value" data-value="100" style="width:100%;"></span></li>
	   		<label>Feathering</label>
	   		<li id="feathering"><p>10 / 10</p><span class="value" data-value="100" style="width:100%;"></span></li>
   ...
   <div class="oar-block">
	   	...
	   	<img src="../imgs/oars/sawyer-square-top-oar-with-shoal-cut-blade.jpg" />

	   	<ul class="oar-specs">

	   		<h2>Sawyer Square-Top Oar with Shoal-Cut Blade</h2>
   ...
   <div class="oar-block">
	   	...
	   	<img src="../imgs/oars/sawyer-square-top-oar-with-vlam-blade.jpg" />

	   	<ul class="oar-specs">

	   		<h2>Sawyer Square-Top Oar with Vlam Blade</h2>

	   		<label>Stiffness</label>
	   		<li id="stiffness"><p>1 / 10</p><span class="value" data-value="10" style="width:10%;"></span></li>
	   		<label>Durability</label>
	   		<li id="durability"><p>7 / 10</p><span class="value" data-value="70" style="width:70%;"></span></li>
	   		<label>Feathering</label>
	   		<li id="feathering"><p>10 / 10</p><span class="value" data-value="100" style="width:100%;"></span></li>
	   	</ul>
...
$(window).scroll(function(){
	...
	var customTop = $(".content-5").height() + $(".content-5").offset().top - 150;
