...
<?php echo "<div class='sixteen columns tab-content clear-content'><h2>standard features</h2>";
if($_SESSION['admin']['rank'] == 1){echo "<i class='admin-manage header-manage manage-features' alt='Manage standard features' title='Manage standard features'></i>";}else{}
echo "</div>";
