...
if(mysql_num_rows($getImages) != 0){
    ...
    if(mysql_num_rows($getFeatureVideo) != 0){
        ...
        if( $rowVid['video_type'] == "vimeo"){

            echo "<iframe class='feature-video' src='//player.vimeo.com/video/".$rowVid['video']."?title=0&amp;byline=0&amp;portrait=0' width='48%' height='304' frameborder='0' webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>";
